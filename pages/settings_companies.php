         ...
         <div class="col-md-12">
            <div class="nav-tabs-custom">
               <ul class="nav nav-tabs">
                  ...
                  <li  class='active'><a href="#clientes" data-toggle="tab">Empresas</a></li >
                              ...
                              <tbody>
                                 <!-- ?php
                                    for($i = 0; $i < count($usuarios); $i++){
                                     ...
                                     echo "<td>";
                                     //echo "<a href='engine_settings.php?mod=7&cat=1&action=1&id=".$usuarios[$i][0]."'>Editar</a>";
                                     echo "<a  class='btn btn-warning' href='engine_settings.php?mod=7&cat=1&action=1&id=".$usuarios[$i][0]."'  >Editar</a>";
                                     echo "</td>";
                                     echo "</tr>";   
                                    }
                                    ? --> 
                              ...
                              <tbody>
                                 <?php
                                    for($i = 0; $i < count($clientes); $i++){
                                     ...
                                     echo "<td>"; 
                                     //echo "<a href='engine_settings.php?mod=7&cat=2&action=1&id=".$clientes[$i][0]."'>Editar</a>";
                                     echo "<a  class='btn btn-warning' href='engine_settings.php?mod=7&cat=2&action=1&id=".$clientes[$i][0]."'  >Editar</a>";
                                     echo "</td>";
                                     echo "</tr>";   
                                    }
                                    ?> 
                              ...
                              <tbody>
                                 <?php
                                    for($i = 0; $i < count($agentes); $i++){
                                     ...
                                     echo "<td>"; 
                                     //echo "<a href='engine_settings.php?mod=7&cat=2&action=1&id=".$clientes[$i][0]."'>Editar</a>";
                                     echo "<a  class='btn btn-warning' href='engine_settings.php?mod=7&cat=3&action=1&id=".$agentes[$i][0]."'>Editar</a>";
                                     echo "</td>";
                                     //echo "<td><a href='engine_settings.php?mod=7&cat=3&action=1&id=".$agentes[$i][0]."'>Editar</a></td>";
                                     echo "</tr>";   
                                    }
                                    ?> 
                              </tbody>
